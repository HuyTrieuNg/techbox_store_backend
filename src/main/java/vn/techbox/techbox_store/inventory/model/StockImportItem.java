...
@Table(name = "stock_import_items", 
    indexes = {
        @Index(name = "idx_import_item_document", columnList = "document_id"),
        @Index(name = "idx_import_item_variation", columnList = "product_variation_id")
    },
    uniqueConstraints = {
        @UniqueConstraint(name = "uk_import_doc_variation", 
...
public class StockImportItem {
    ...
    // Helper method để tính tổng giá trị
